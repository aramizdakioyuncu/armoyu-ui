    ...
    const fetchFriends = async (isLoadMore = false) => {
        ...
        try {
            ...
            if (data && Array.isArray(data)) {
                ...
                console.log(`[ProfileContent] Fetched ${mappedFriends.length} friends for ${displayUser.username}, Page: ${targetPage}`);
            }
            else {
