...
export function SocialTab() {
    ...
    const fetchLivePosts = useCallback(async () => {
        ...
        setLastRawData(null);
        try {
            console.log("[SocialTab] Veri çekiliyor... API Key:", apiKey ? "Mevcut" : "Eksik");
