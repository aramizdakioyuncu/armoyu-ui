...
export const roles = {
  ...
  assettoOfficial: new Role({ id: 'assetto_official', name: 'Oyun Yetkilisi (Assetto Corsa)', color: 'var(--armoyu-primary)' }),
  mcOfficial: new Role({ id: 'mc_official', name: 'Oyun Yetkilisi (Minecraft)', color: 'var(--armoyu-primary)' }),
  responsible: new Role({ id: 'responsible', name: 'Sorumlu', color: 'var(--armoyu-primary)' }),
