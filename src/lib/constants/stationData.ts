...
export const eventList: ArmoyuEvent[] = [
  ...
  new ArmoyuEvent({
    id: 4,
    name: 'ARMOYU Lojistik: Avrupa Konvoyu',
    gameName: 'Euro Truck Simulator 2',
    status: 1,
    type: 'GROUP',
    thumbnail: 'https://images.unsplash.com/photo-1601584115197-04ecc0da31d7?q=80&w=1600',
    date: '12 Mayıs 2026, 21:00',
    location: 'ARMOYU ProMods #1',
    participantLimit: 50,
    currentParticipants: 32,
    description: 'Büyük ARMOYU konvoyu başlıyor! Rotterdam\'dan çıkıp Roma\'ya kadar sürecek olan bu devasa lojistik operasyonunda yerini al.',
  }),
  new ArmoyuEvent({
    id: 5,
    name: 'Haftalık ETS2 Serbest Sürüş',
    gameName: 'Euro Truck Simulator 2',
    status: 1,
    type: 'BIREYSEL',
    thumbnail: 'https://images.unsplash.com/photo-1586191552066-d52dd1e3af86?q=80&w=1600',
    date: 'Her Cuma, 22:30',
    location: 'ARMOYU Konvoy Sunucusu',
    participantLimit: 100,
    currentParticipants: 45,
    description: 'Haftanın yorgunluğunu Avrupa yollarında atıyoruz. Şirket bağımsız, herkes davetlidir!',
  }),
  new ArmoyuEvent({
    id: 6,
    name: 'GTA V: Los Santos Sokak Yarışları',
    gameName: 'GTA V / FiveM',
    status: 1,
    type: 'BIREYSEL',
    thumbnail: 'https://images.unsplash.com/photo-1605898399783-1820b7f53631?q=80&w=1600',
    date: '18 Mayıs 2026, 22:00',
    location: 'FiveM ARMOYU RP',
    participantLimit: 32,
    currentParticipants: 12,
    description: 'Los Santos\'un altını üstüne getirmeye hazır mısın? Modifiyeli aracını kap gel, polislerden kaçarken bitiş çizgisine ilk sen ulaş!',
  }),
  new ArmoyuEvent({
    id: 7,
    name: 'Assetto Corsa: Drift Gecesi',
    gameName: 'Assetto Corsa',
    status: 1,
    type: 'GROUP',
    thumbnail: 'https://images.unsplash.com/photo-1541899481282-d53bffe3c35d?q=80&w=1600',
    date: '20 Mayıs 2026, 20:00',
    location: 'Assetto Corsa ARMOYU Drift',
    participantLimit: 20,
    currentParticipants: 18,
    description: 'Lastik kokusu ciğerlerimize dolsun! Japonya dağ yollarında yan yana süzülüyoruz. Profesyonel driftçiler ve yeni başlayanlar için ayrı klasmanlar!',
  }),
  new ArmoyuEvent({
    id: 8,
    name: 'FiveM: Büyük Banka Soygunu (RP)',
    gameName: 'GTA V / FiveM',
    status: 1,
    type: 'GROUP',
    thumbnail: 'https://images.unsplash.com/photo-1519669011783-4eaa93fa1b7d?q=80&w=1600',
    date: '22 Mayıs 2026, 21:00',
    location: 'FiveM ARMOYU RP',
    participantLimit: 15,
    currentParticipants: 15,
    description: 'Şehir tarihindeki en büyük soygun planlanıyor. Ekipler kuruldu, roller dağıtıldı. Adrenalin dolu bir roleplay deneyimi!',
  }),
  new ArmoyuEvent({
    id: 9,
    name: 'Assetto Corsa: Spa-Francorchamps Pist Günü',
    gameName: 'Assetto Corsa',
    status: 1,
    type: 'BOTH',
    thumbnail: 'https://images.unsplash.com/photo-1533130061792-64b345e4a833?q=80&w=1600',
    date: '25 Mayıs 2026, 14:00',
    location: 'Spa-Francorchamps / Online',
    participantLimit: 24,
    currentParticipants: 10,
    description: 'Efsanevi Spa pistinde en hızlı turu kim atacak? GT3 araçlarıyla teknik sürüşün zirvesine çıkıyoruz.',
  })
];
