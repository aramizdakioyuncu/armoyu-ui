          ...
          <div className="flex items-center gap-3">
             <div className="relative group">
                ...
                <input 
                  ...
                  className="pl-12 pr-6 py-3 bg-white/5 border border-armoyu-header-border rounded-2xl text-xs font-black uppercase tracking-widest focus:outline-none focus:ring-2 focus:ring-blue-500/20 transition-all w-full md:w-64"
                />
             </div>
             <button className="p-3 bg-white/5 border border-armoyu-header-border rounded-2xl text-armoyu-text-muted hover:text-blue-500 transition-all">
                <Filter size={20} />
             </button>
          </div>
        </div>
