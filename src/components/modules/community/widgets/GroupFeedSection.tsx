            ...
            <div className="glass-panel p-6 rounded-[40px] border border-armoyu-card-border bg-armoyu-card-bg shadow-xl animate-in fade-in slide-in-from-bottom-4 duration-500">
               <div className="flex gap-4 items-center leading-none">
                  <div className="relative shrink-0">
                     <img src={user.avatar || undefined} className="w-12 h-12 rounded-2xl border-2 border-blue-500/20 object-cover shadow-lg" alt="Avatar" />
                  ...
                  <div className="flex-1 relative group">
                     <input 
                        ...
                        className="w-full bg-black/5 dark:bg-white/5 border border-black/5 dark:border-white/5 rounded-2xl px-6 py-4 text-sm font-bold text-armoyu-text focus:outline-none focus:ring-2 focus:ring-blue-500/20 transition-all italic placeholder:opacity-30" 
                     />
                  </div>
               </div>
               <div className="flex justify-between items-center mt-6 pt-6 border-t border-black/5 dark:border-white/5 leading-none">
                  <div className="flex gap-2">
                     <button className="flex items-center gap-2 px-4 py-2.5 rounded-xl hover:bg-black/5 dark:hover:bg-white/5 text-[10px] font-black text-armoyu-text-muted hover:text-blue-500 transition-all italic uppercase tracking-widest border border-transparent hover:border-blue-500/10 active:scale-95">
                        <ImageIcon size={14} />
                        MEDYA EKLE
                     </button>
                  </div>
                  <button className="flex items-center gap-2 px-8 py-3 bg-blue-600 hover:bg-blue-500 text-white text-[10px] font-black uppercase tracking-widest rounded-2xl shadow-lg shadow-blue-600/20 active:scale-95 transition-all italic border border-blue-500/20">
                     <Send size={14} />
                     PAYLAŞ
                  </button>
               </div>
