...
export function NewsHero() {
  return (
    <div className="relative rounded-[40px] overflow-hidden bg-zinc-900 border border-white/5 p-12 group">
      <div className="absolute top-0 right-0 w-96 h-96 bg-armoyu-primary/10 blur-[100px] -mr-32 -mt-32 transition-all duration-1000 group-hover:bg-armoyu-primary/20"></div>
      <div className="relative z-10 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
        <div className="space-y-6 text-left">
          <div className="inline-flex items-center gap-2 px-4 py-2 bg-armoyu-primary/10 rounded-2xl border border-armoyu-primary/20">
             <Zap size={16} className="text-armoyu-primary animate-pulse" />
             <span className="text-[10px] font-black text-armoyu-primary uppercase tracking-widest">GÜNCEL HABERLER</span>
          </div>
          <h1 className="text-4xl md:text-6xl font-black text-white uppercase tracking-tighter italic leading-none">
            DÜNYADAN <br /> 
            <span className="text-armoyu-primary italic">GELİŞMELER</span>
          </h1>
        ...
        <div className="grid grid-cols-2 gap-4">
           <div className="p-8 bg-white/5 rounded-[32px] border border-white/5 backdrop-blur-xl flex flex-col gap-4 group/card hover:border-armoyu-primary/30 transition-all">
           ...
           <div className="p-8 bg-white/5 rounded-[32px] border border-white/5 backdrop-blur-xl flex flex-col gap-4 group/card hover:border-armoyu-primary/30 transition-all">
              <Newspaper size={24} className="text-armoyu-primary" />
              <div className="flex flex-col">
