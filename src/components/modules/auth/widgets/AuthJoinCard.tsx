  ...
  return (
    <div className="w-full max-w-[320px] bg-[#0a0a0f]/60 backdrop-blur-xl rounded-[32px] border border-white/5 p-8 relative overflow-hidden group shadow-2xl">
      ...
      <header className="relative z-10 mb-8">
        <div className="w-12 h-12 rounded-2xl bg-gradient-to-br from-blue-600 to-purple-600 flex items-center justify-center mb-6 shadow-lg shadow-blue-500/20 group-hover:scale-110 transition-transform duration-500">
        ...
        <h3 className="text-2xl font-black text-white italic uppercase tracking-tighter leading-tight mb-3">
          AKSİYONUN <br/> <span className="text-blue-500">PARÇASI OL</span>
        </h3>
      ...
      <div className="relative z-10 space-y-4 mb-8">
         {[
           ...
           <div key={i} className="flex items-center gap-3 group/item">
              <div className="w-6 h-6 rounded-lg bg-white/5 border border-white/10 flex items-center justify-center text-blue-500 group-hover/item:bg-blue-500 group-hover/item:text-white transition-all">
                 {item.icon}
              </div>
      ...
      <div className="relative z-10 space-y-3">
         <Button 
            variant="primary" 
            className="w-full h-11 text-[10px] font-black uppercase tracking-[0.2em] rounded-xl shadow-lg shadow-blue-600/10 group/btn"
