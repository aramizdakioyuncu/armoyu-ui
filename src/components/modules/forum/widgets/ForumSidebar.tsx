      ...
      <div className="space-y-10">
         ...
         <div className="glass-panel p-6 rounded-[32px] border border-armoyu-card-border bg-armoyu-card-bg">
            ...
            <div className="relative">
               <input type="text" placeholder="Kelime yazın..." className="w-full bg-black/5 dark:bg-white/5 border border-armoyu-card-border rounded-xl px-4 py-3 text-sm font-bold focus:outline-none focus:ring-2 focus:ring-armoyu-primary transition-all" />
         ...
         <div className="glass-panel p-8 rounded-[40px] border border-armoyu-card-border bg-armoyu-card-bg">
            ...
            <div className="mt-8 pt-6 border-t border-armoyu-card-border">
               <p className="text-[10px] font-black text-armoyu-primary uppercase tracking-widest mb-4">Yeni Kayıt</p>
