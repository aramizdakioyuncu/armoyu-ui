...
export function GeneralTab() {
  return (
    <div className="space-y-12">
      <h3 className="text-2xl font-black italic uppercase tracking-tighter border-l-4 border-armoyu-primary pl-4">Temel Bileşenler</h3>
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        <div className="glass-panel p-8 rounded-[40px] space-y-6">
          ...
          <div className="flex flex-wrap gap-4">
            ...
            <Button className="bg-gradient-to-r from-armoyu-primary to-indigo-600">Premium Buton</Button>
        ...
        <div className="glass-panel p-8 rounded-[40px] space-y-6">
          ...
          <div className="flex items-center gap-8">
             <div className="text-4xl font-black text-armoyu-primary"><RollingNumber value="14.2" suffix="B" /></div>
             <div className="text-3xl font-black text-armoyu-text opacity-60"><RollingNumber value="1250" /></div>
          </div>
        </div>
